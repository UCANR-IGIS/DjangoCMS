...
SECRET_KEY = "django-insecure-_pfhf(9uqmdd7f#_5!b4pu^330ztqps$6uf9((7t-26rp6wxdx"
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "CMSTest", "templates"),],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
CMS_TEMPLATES = [
    ...
    ("resource.html", _("Resources")),
    ("events.html", _("Events")),
]
